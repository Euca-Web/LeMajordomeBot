...
module.exports = {
    ...
    async run(bot, message, args){
        ...
        try{
            ...
            if(!user) return message.reply("Pas de membres à bannir.")
            ...
            try{await user.send(`Tu as été bannis du serveur ${message.guild.name} par ${message.user.tag} pour la raison : \`${reason}\``)}catch(err) {}
